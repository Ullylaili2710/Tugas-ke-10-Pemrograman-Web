...
$cases = mysqli_query($koneksi,"select * from datacovid19"); // Mengambil data dari database
while($row = mysqli_fetch_array($cases)){
	$negara[] = $row['country'];
	$query = mysqli_query($koneksi,"SELECT sum(total_cases) as total_cases from datacovid19 where id_covid ='".$row['id_covid']."'");
